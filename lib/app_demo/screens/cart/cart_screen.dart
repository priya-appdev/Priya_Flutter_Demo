    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              ref.read(cartProvider.notifier).refreshData();
            },
      ...
      body: cartState.isLoading
          ? Center(child: const ProductShimmer())
          : RefreshIndicator(
              ...
              onRefresh: () async {
                await ref.read(cartProvider.notifier).refreshData();
              },
            ),
    );
  }
          ...
          ClipRect(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Discounted: \$${cart.discountedTotal.toStringAsFixed(2)}',
                  style: TextStyle(fontFamily: 'Poppins', fontSize: 15),
                ),
              ],
            ),
